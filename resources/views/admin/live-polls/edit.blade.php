    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.live-polls.update', $livePoll) }}" method="POST" id="pollForm">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('session_id') is-invalid @enderror" id="session_id" name="session_id" required>
                                ...
                                @foreach($sessions as $session)
                                    <option value="{{ $session->id }}" {{ old('session_id', $livePoll->session_id) == $session->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('question') is-invalid @enderror" id="question" name="question" value="{{ old('question', $livePoll->question) }}" required>
                            @error('question')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input @error('multiple_choice') is-invalid @enderror" id="multiple_choice" name="multiple_choice" value="1" {{ old('multiple_choice', $livePoll->multiple_choice) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="options-container">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <button type="button" class="btn btn-danger remove-option" style="display: {{ $loop->index > 1 ? 'block' : 'none' }}">
