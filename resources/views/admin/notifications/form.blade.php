...
@section('title', isset($notification) ? 'Edit Notification' : 'Create Notification')
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ isset($notification) ? 'Edit Notification' : 'Create Notification' }}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ isset($notification) ? route('admin.notifications.update', $notification) : route('admin.notifications.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('scheduled_at') is-invalid @enderror" id="scheduled_at" name="scheduled_at" value="{{ old('scheduled_at', isset($notification) ? $notification->scheduled_at?->format('Y-m-d\TH:i') : '') }}">
